...
> **Quick reference for configuring UserApp Desktop - icons, metadata, and build settings**

**Related Guides:**
- [Getting Started Guide](./DESKTOP_APP_GETTING_STARTED.md) - Development workflow and architecture
...
```json
{
  "name": "desktop-userapp",
  "productName": "UserApp",
  "version": "1.0.0",
  "description": "UserApp - Modern Electron desktop application with user management",
  "appId": "com.userapp.desktop"
}
```
...
|-------|---------|---------|
| `name` | NPM package name (internal) | `desktop-userapp` |
| `productName` | Display name shown to users | `UserApp` |
| `version` | App version (semantic) | `1.0.0`, `1.2.3` |
| `description` | App description | `UserApp - User Management` |
| `appId` | Unique identifier (reverse domain) | `com.userapp.desktop` |

### Customization

```json
{
  "name": "desktop-userapp",           // Keep this (internal)
  "productName": "UserApp Pro",         // ✏️ Change display name
...
- ✅ Product name (`UserApp`)
- ✅ App ID (`com.userapp.desktop`)
...
- **[Getting Started Guide](./DESKTOP_APP_GETTING_STARTED.md)** - Development workflow, routing, authentication
- **[README](../README.md)** - Project overview and quick start
- **[Electron Builder Docs](https://www.electron.build/)** - Official build configuration
- **[Electron Window Options](https://www.electronjs.org/docs/latest/api/browser-window)** - Window customization
